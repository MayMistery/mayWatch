...
test('panel chart loader falls back to global Chart exposed by UMD bundle for trend rendering', async () => {
  ...
  URL.createObjectURL = () => 'data:text/javascript,globalThis.Chart%20%3D%20function%20ChartCtor()%20%7B%20globalThis.__chartRenderCount%2B%2B%3B%20%7D%3B';
  URL.revokeObjectURL = () => {};
  globalThis.__chartRenderCount = 0;

  try {
    const { Panel } = await import('../content/panel.js');
